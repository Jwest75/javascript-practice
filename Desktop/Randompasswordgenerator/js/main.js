...
copyIconE1.addEventListener("click", () =>{
    copyPassword();if(inputE1.value){
        alertContainerE1.classList.remove("active");
        setTimeout(()=>{alertContainerE1.classList.add
    ("active");
        },2000);
    }
...
function createPassword() {
    ...
    inputE1.value = password ;alertContainerE1.innerText = 
    password +"Copied!"
}
...
function copyPassword() {
    ...
    alertContainerE1.innerText = 
    password + "Copied !"
} 
//i stoped at and the transitioning of the green password copied
